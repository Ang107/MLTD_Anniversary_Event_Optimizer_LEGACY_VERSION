...
const SETTING_SCALAR_FIELDS = [
  ...
  ["TIME_SEC_BETWEEN_SONG_AND_SONG", "曲終了→次曲開始 (秒)"],
  ["FROM_SONG_END_TO_LIVE_TIME_SEC", "曲終了→ライブ画面 (秒)"],
  ["SPARK_DRINK_10", "スパークドリンク10 個数"],
  ["SPARK_DRINK_20", "スパークドリンク20 個数"],
  ["SPARK_DRINK_30", "スパークドリンク30 個数"],
  ["SPARK_DRINK_MAX", "スパークドリンクMAX 個数"],
  ["MAX_STAMINA", "スタミナ最大量"],
];
